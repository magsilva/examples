...
public class OptionProcessingException extends Exception {
    ...
    /* Removed for compatibility with Java 1.3
    public OptionProcessingException(String message, Throwable cause) {
        super(message, cause);
    }

    public OptionProcessingException(Throwable cause) {
        super(cause);
    }
    */
}
