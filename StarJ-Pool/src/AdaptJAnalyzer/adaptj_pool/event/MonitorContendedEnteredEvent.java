...
/**
 * An Event corresponding to the <code>JVMPI_MONITOR_CONTENDED_ENTERED</code> event. This event is triggered when a thread 
 * successfully enters a Java monitor after having waited for it to be released by another thread.
 *
 * @author Bruno Dufour
...
public class MonitorContendedEnteredEvent extends MonitorEvent {
    ...
    public MonitorContendedEnteredEvent(int object) {
        super(object);

        setTypeID(ADAPTJ_MONITOR_CONTENDED_ENTERED);
    }
}
