...
/**
 * An Event corresponding to the <code>JVMPI_MONITOR_CONTENDED_ENTER</code> event. This event is triggered when a thread
 * is attempting to enter a Java monitor already acquired by another thread.
 *
 * @author Bruno Dufour
...
public class MonitorContendedEnterEvent extends MonitorEvent {
    ...
    public MonitorContendedEnterEvent(int object) {
        super(object);

        setTypeID(ADAPTJ_MONITOR_CONTENDED_ENTER);
    }
}
