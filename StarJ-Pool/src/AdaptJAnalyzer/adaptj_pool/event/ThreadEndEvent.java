...
/**
 * An Event corresponding to the <code>JVMPI_THREAD_END</code> event. This event is triggered when a thread
 * ends in the Java VM.
 *
 * @author Bruno Dufour
 ...
 */
public class ThreadEndEvent extends AdaptJEvent {
    public ThreadEndEvent() {
        setTypeID(ADAPTJ_THREAD_END);
    }
}
