...
/**
 * An Event corresponding to the <code>JVMPI_MONITOR_WAITED</code> event. This event is triggered when a thread finishes
 * waiting on a object.
 *
 * @author Bruno Dufour
...
public class MonitorWaitedEvent extends TimedMonitorEvent {
    ...
    public MonitorWaitedEvent(int object, long timeout) {
        super(0, -1L);
        setTypeID(ADAPTJ_MONITOR_WAITED);
    }
}
