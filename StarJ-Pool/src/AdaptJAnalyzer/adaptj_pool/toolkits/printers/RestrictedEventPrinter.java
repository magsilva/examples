...
public class RestrictedEventPrinter extends EventOperation {
    protected String fileName = null;
    protected PrintStream pw;
    
    public RestrictedEventPrinter(String name, String description) {
        super(name, description);
        fileName = "AdaptJ.restricted.txt";
    }

    public RestrictedEventPrinter(String name, String description, String fileName) {
        super(name, description);
    ...
    */
    ...
    public void doApply(EventBox box) {
        ...
        if (event instanceof ArenaDeleteEvent) {
            ...
            pw.println("ClassLoadEvent[env_id=" + e.getEnvID() + ", class_name=" + e.getClassName()
                    + ", num_methods=" + e.getNumMethods()
