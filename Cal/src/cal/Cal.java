...
public class Cal
{
	...
	static String smon[] = new String[] { "Janeiro", "Fevereiro", "Março",
	...
	static public void main(String[] argv)
	{
		...
		if (argc >= 2 || argc == 0) {
			...
			if (argc == 0) { /* current month */
				...
				if (m < 1 || m > 12) {
					System.err.println("Cal: " + argv[0] + " mes invalido.");
					System.exit(1);
				}
				y = 0;
				try {
				...
				if (y < 1 || y > 9999) {
					System.err.println("Cal: " + argv[1] + " ano invalido.");
					System.exit(2);
				}
			}
			System.out.println("   " + smon[m - 1] + " " + y);
			...
			if (y < 1 || y > 9999) {
				System.err.println("Cal: " + argv[0] + ": ano invalido.\n");
				System.exit(2);
			}
			for (int zi = 1; zi < 13; zi++) {
				System.out.println("   " + smon[zi - 1] + " " + y);
				System.out.println(dayw);
	...
	private static String cal(int dds, int n)
	{
		if (n == 19)
