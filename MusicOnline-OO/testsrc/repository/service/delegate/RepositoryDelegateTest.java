...
public class RepositoryDelegateTest extends TestCase {
	...
	private static aspect FaultInjector {
		...
		// Write a before advice that throws a RemoteException
		// when any method of RepositoryService is called 
		// in control-flow of a method in RepositoryDelegateTest
		// and if injectFault flag is set to true
	}
}
